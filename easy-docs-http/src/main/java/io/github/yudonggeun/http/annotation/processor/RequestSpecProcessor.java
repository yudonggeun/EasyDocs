...
import io.github.yudonggeun.http.annotation.BodySpec;
...
@SupportedAnnotationTypes({"io.github.yudonggeun.http.annotation.RequestSpec",})
@SupportedSourceVersion(SourceVersion.RELEASE_8)
public class RequestSpecProcessor extends AbstractProcessor {
    ...
    public boolean process(Set<? extends TypeElement> annotations, RoundEnvironment roundEnv) {
        for (Element element : roundEnv.getElementsAnnotatedWith(RequestSpec.class)) {
            ...
            TypeSpec.Builder classBuilder = TypeSpec.classBuilder(requestFormClassName)
                    .addSuperinterface(HttpRequestInput.class)
                    .addModifiers(Modifier.PUBLIC)
